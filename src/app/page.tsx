    ...
    <>
      ...
      <div className="space-y-6 px-5">
        <div className="relative">
          ...
          <button className="absolute bottom-6 left-1/2 -translate-x-1/2 rounded-full bg-white px-6 py-2 font-bold text-black transition hover:bg-neutral-800">
            Comprar
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 p-4 px-3 md:p-5">
          <div className="flex max-w-[60%] flex-col gap-3 px-5">
            ...
            <button className="mt-5 mb-3 rounded-full bg-black px-3 py-2 font-semibold text-white">
              Ver coleção
            </button>
          </div>
